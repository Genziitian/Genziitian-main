...
-- 5. Website Orders: user can only see their own orders
...
-- Service role full access for internal management
...
-- Manager full read access for platform administration
