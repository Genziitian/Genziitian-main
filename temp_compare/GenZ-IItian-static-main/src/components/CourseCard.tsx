...
export default function CourseCard({ course, className = '' }: CourseCardProps) {
  ...
  return (
    ...
    >
      {/* SALE Badge */}
      <div className="absolute top-6 right-6 z-10 rotate-12 group-hover:rotate-6 transition-transform">
        <div className="bg-red-500 text-white font-black px-4 py-2 rounded-xl border-[3px] border-[#0b1120] shadow-[4px_4px_0px_#0b1120] text-sm tracking-widest uppercase transform -translate-y-2 translate-x-2">
          SALE
        </div>
      </div>
