...
export const apiService = {
  ...
  createOrder: async (payload: { amount: number, email: string, courseIds: string[], discountCode?: string, bundleId?: string, referralCode?: string, coinsToApply?: number, qualifierPlan?: string, qualifierBaseCourseId?: string }) => {
    if (!isProduction) {
